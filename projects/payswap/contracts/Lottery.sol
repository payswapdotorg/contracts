...
contract LotteryContract {
    ...
    function emitUpdateMiscellaneous(
        ...
        uint __collectionId = IMarketPlace(IContract(contractAddress).marketCollections()).addressToCollectionId(msg.sender);
    ...
    function drawFinalNumberAndMakeLotteryClaimable(uint256 _lotteryId)
        ...
        lock
    {
        require(_lotteries[_lotteryId].status == LotteryStatus.Close);
