...
interface IAcceleratorVoter {
    function _deposit(int256,uint256,uint256) external;
    function _withdraw(int256,uint256,uint256) external;
...
contract AML is ERC20Votes, Ownable {
    ...
    function attachProfile() external {
        ...
        (string memory _ssid,,,,,,,,,,) = IProfile(profile).profileInfo(_profileId);
...
interface IValuePool {
    ...
    function getUserPercentile(uint) external view returns(uint);
